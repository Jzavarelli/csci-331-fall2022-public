...
class SuperHero extends SuperHuman {
	...
	battle(superVill) {
		...
		if(this.powerLevel >= superVill.powerLevel)
		{
			return true;
		}
		else
...
function selectionChanged() {
	...
	var battleOutcome = selectedHero.battle(selectedVillain);

	if(battleOutcome == true)
	{
		winnerId.textContent = "Winner: " + selectedHeroValue + "!";
	}
	else if(battleOutcome == false)
	{
		winnerId.textContent = "Winner: " + selectedVillainValue + "!";
	}
}
